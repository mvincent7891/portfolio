...
export const projects = {
  gnothiMobile: {
    ...
    url: 'https://play.google.com/store/apps/details?id=com.gnothi.demo',
    img: './images/gnothi_mobile.png',
    color: colors[6],
    skills: [
      'Jave', 'Android', 'Ruby', 'Rails', 'Product MGMT'
    ],
  ...
  gnothi: {
    ...
    color: colors[5],
    skills: [
      'React', 'Redux', 'JS', 'Rails', 'NLP', 'Product Design'
    ],
  ...
  asl: {
    ...
    color: colors[5],
    skills: [
      'Matlab', 'Computer Vision', 'Pattern Recognition', 'Neural Networks'
    ],
  ...
  hemo: {
    ...
    color: colors[6],
    skills: [
      'PIC', 'Embedded Systems', 'Plethysmography', 'Android'
    ],
  ...
  asteroids: {
    ...
    color: colors[8],
    skills: [
      'Python', 'HTML5 Canvas', 'Object Oriented Design'
    ],
